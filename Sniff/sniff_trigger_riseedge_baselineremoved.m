function [sniff_onset] = sniff_trigger_riseedge_baselineremoved(sniff_voltage, trigger_threshold, fs, minimum_sniff_duration_second)
...
[~,inh_pks] = findpeaks(sniff_voltage, fs,'MinPeakDistance',minimum_sniff_duration_second,'MinPeakHeight',0.2);
